...
def github_login(request):
    ...
    redirect_uri = "http://jundamin.pythonanywhere.com/users/login/github/callback"
    return redirect(
...
def kakao_login(request):
    ...
    redirect_uri = "http://jundamin.pythonanywhere.com/users/login/kakao/callback"
    return redirect(
...
def kakao_callback(request):
    try:
        ...
        account_json = userinfo_json.get("kakao_account")
        print(account_json)
        profile_json = account_json.get("profile")
        print(profile_json)
